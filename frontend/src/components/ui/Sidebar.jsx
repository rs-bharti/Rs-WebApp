...
import {
  ...
  ChevronDown, BookOpen, LayoutGrid, BookMarked, CalendarDays, Landmark,
} from 'lucide-react';
...
const MASTER_ROUTES = {
  ...
  'Branch':         { slug: 'branch-master',  icon: Database },
...
const OTHER_ROUTES = {
  ...
  'Money Ledger':      { slug: 'other/money-ledger',      icon: Landmark },
};
